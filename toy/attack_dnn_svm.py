...
if True:
    ...
    # Save to disk
    sec_eval.save(fm.join(fm.abspath(__file__), 'dnn_svm_seceval.gz'))

sec_eval = CSecEval.load(fm.join(fm.abspath(__file__), 'dnn_svm_seceval.gz'))

plot_seceval(sec_eval, eps, label='DNN-SVM', name='dnn_svm')
